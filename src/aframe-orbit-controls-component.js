...
window.AFRAME.registerComponent('orbit-controls', {
  ...
  updateOrientation: (function () {
    ...
    return function () {
      ...
      // Set a minimum x-coordinate of -5 so we can't go below the horizon.
      this.el.setAttribute('rotation', {
        x: Math.min(-5, THREE.Math.radToDeg(hmdEuler.x) + THREE.Math.radToDeg(pitchObject.rotation.x)),
